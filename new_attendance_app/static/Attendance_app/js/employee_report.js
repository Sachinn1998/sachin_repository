async function getdata(){
	...
	const response = await fetch(" http://127.0.0.1:8000/employee_attendance/emp_report/", {
    method: "POST",
   ...
   if (result.data == "outofrange") {
    ...
    document.getElementById("dropdownMenuButton").style.display = "none";   
   	...
   	var tbl = "<table id='employee' class='table'><thead><tr id='table_header'><th>Date</th><th>Time</th><th>Event</th><th>Details</th></tr></thead><tbody>";
